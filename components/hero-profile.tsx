  ...
  return (
    <div className="flex flex-col items-start gap-4 mb-8 md:flex-row md:items-center">
      ...
      <div>
        ...
        <a href="https://www.uowdubai.ac.ae/" target="_blank" className="flex items-center justify-center px-3 py-1 mt-4 text-sm font-medium bg-blue-200 border border-blue-700 dark:border-blue-500 dark:bg-blue-900 w-fit rounded-xl">
